...
def generate_historical_plot():
    ...
    plt.text(2004, 610, f"⬤ No Package Citation (n = {total_no_package:})", size = 10, weight = "demibold", color = "gray")
    plt.text(2004, 580, f"⬤ Cites Incorrect Package (n = {total_incorrect_package:})", size = 10, weight = "demibold", color = (0.60, 0, 0.05))
    plt.text(2004, 550, f"⬤ Cites Correct Package (n = {total_correct_package:})", size = 10, weight = "demibold", color = (0.0, 0.6, 0.3))
    ...
    plt.text(2004, 585, f"⬤ Meets Basic Reproducibility Criteria (n = {total_reproducible:})", size = 10, weight = "demibold", color = (0.05, 0.3, 0.5))
    plt.text(2004, 615, f"⬤ Fails Basic Reproducibility Criteria (n = {total_not_reproducible:})", size = 10, weight = "demibold", color = "gray")
